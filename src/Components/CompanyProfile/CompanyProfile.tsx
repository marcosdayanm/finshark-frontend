...
const CompanyProfile = (props: Props) => {
  const ticker = useOutletContext<string>(); // Ésto es para pasar un elemento de un contexto desde todo el proyecto, a esta ventanita que está dentro de una route según entendí
  ...
  }, []); // Es imoortante poner los squared brackets al final porque sino va a llamar a la API como 1000 veces en un segundo continuamente, sino valio burger
  return (
    <>
      {companyData ? (
        <>
...
function formatLargeNonMonetaryNumber(value: number): string {
  if (value >= 1e9) {
